...
go
-- posts data
insert into posts values ('Post one', 'Post one full', 'This is post content.', '1-2-2013')
insert into posts values ('Post two', 'Post two full', 'This is another post content.', '3-2-2014')
-- users data
